...
public class SagaReplyListener {
    ...
    public void handleSagaReply(TransactionEventMessage message) {
        ...
        try {
            ...
            if ("PIX_PROCESSED_REPLY".equals(eventType)) {
                String transactionId = message.payload().accountId();
                String finalStatus = message.payload().status();
                String failureReason = message.payload().accountNumber();
